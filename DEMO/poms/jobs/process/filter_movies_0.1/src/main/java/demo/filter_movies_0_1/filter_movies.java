...
package demo.filter_movies_0_1;
 ...
 * @status
 */
public class filter_movies implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (userInput != null) {
				...
				this.setProperty("userInput", userInput.toString());
	...
	private final String jobName = "filter_movies";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					filter_movies.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(filter_movies.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					...
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "valid_movies";
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([movieID] INT ,[title] VARCHAR(29)  ,[releaseYear] INT ,[url] VARCHAR(66)  ,[directorName] VARCHAR(20)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([movieID],[title],[releaseYear],[url],[directorName]) VALUES (?,?,?,?,?)";
				...
				String dbname_tDBOutput_2 = "demo";
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					...
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "invalid_movies";
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
					stmtCreate_tDBOutput_2.execute("CREATE TABLE [" + tableName_tDBOutput_2
							+ "]([movieID] INT ,[title] VARCHAR(29)  ,[releaseYear] INT ,[url] VARCHAR(66)  ,[directorID] INT )");
				}
				String insert_tDBOutput_2 = "INSERT INTO [" + tableName_tDBOutput_2
						+ "] ([movieID],[title],[releaseYear],[url],[directorID]) VALUES (?,?,?,?,?)";
...
// ###############################
				...
				String dbquery_tDBInput_2 = "SELECT movies.movieID,\n		movies.title,\n		movies.releaseYear,\n		movies.url,\n		movies.directorID\nFROM	movies";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row1.movieID = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row1.title = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row1.releaseYear = rs_tDBInput_2.getInt(3);
							if (rs_tDBInput_2.wasNull()) {
								row1.releaseYear = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							row1.directorID = rs_tDBInput_2.getInt(5);
							if (rs_tDBInput_2.wasNull()) {
								row1.directorID = null;
							}
						}
...
// # Output table : 'valid_movies'
									...
									valid_movies_tmp.directorName = row2.directorName;
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									invalid_movies_tmp.releaseYear = row1.releaseYear;
									invalid_movies_tmp.url = row1.url;
									invalid_movies_tmp.directorID = row1.directorID;
...
// Start of branch "invalid_movies"
							if (invalid_movies != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "invalid_movies");
								}
								...
								if (invalid_movies.title == null) {
									...
									pstmt_tDBOutput_2.setString(2, invalid_movies.title);
								}

								if (invalid_movies.releaseYear == null) {
									pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(3, invalid_movies.releaseYear);
								}

								if (invalid_movies.url == null) {
									pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(4, invalid_movies.url);
								}

								if (invalid_movies.directorID == null) {
									pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(5, invalid_movies.directorID);
								}
...
// ###############################      
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_1 = "SELECT directors.directorID,\n		directors.directorName\nFROM	directors";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row2.directorID = rs_tDBInput_1.getInt(1);
							if (rs_tDBInput_1.wasNull()) {
								row2.directorID = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row2.directorName = null;
						} else {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row2.directorName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row2.directorName = tmpContent_tDBInput_1;
								}
							} else {
								row2.directorName = null;
							}
	...
	public static void main(String[] args) {
		final filter_movies filter_moviesClass = new filter_movies();

		int exitCode = filter_moviesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = filter_movies.class.getClassLoader()
					.getResourceAsStream("demo/filter_movies_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = filter_movies.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("userInput", "id_Integer");
					try {
						context.userInput = routines.system.ParserUtils
								.parseTo_Integer(context.getProperty("userInput"));
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("userInput")) {
				context.userInput = (Integer) parentContextMap.get("userInput");
			}
		}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : filter_movies");
		}
