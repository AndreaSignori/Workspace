 ...
 * @status
 */
public class gerarchie implements TalendJob {
	...
	private final String jobName = "gerarchie";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(gerarchie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tTranspose_1_TransposeOut_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {

		tTranspose_1_TransposeIn_error(exception, errorComponent, globalMap);

	}

	public void tTranspose_1_TransposeIn_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DEMO_gerarchie = new byte[0];
		static byte[] commonByteArray_DEMO_gerarchie = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_gerarchie.length) {
					if (length < 1024 && commonByteArray_DEMO_gerarchie.length == 0) {
						commonByteArray_DEMO_gerarchie = new byte[1024];
					} else {
						commonByteArray_DEMO_gerarchie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_gerarchie, 0, length);
				strReturn = new String(commonByteArray_DEMO_gerarchie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_gerarchie) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "movieID", "title", "releaseYear", "url", "directorID", });
...
///////////////////////    			
				...
				String fileName_tPivotToColumnsDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/out.csv"))
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/talend/Desktop/movies.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/talend/Desktop/movies.csv", "US-ASCII", ";", "\n", false, 1, 0,
						...
						if (row1 != null) {
							...
							if (!pivot_ExiststPivotToColumnsDelimited_1) {
								...
								pivot_KeystPivotToColumnsDelimited_1
										.add(pivot_KeytPivotToColumnsDelimited_1.append(row1.movieID).toString());
							...
							gKvaluetPivotToColumnsDelimited_1
									.add(group_KeytPivotToColumnsDelimited_1.append(row1.movieID).toString());
							...
							if (!group_ExiststPivotToColumnsDelimited_1) {
								...
								aggValuestPivotToColumnsDelimited_1.add(String.valueOf(row1.releaseYear));
								...
								if (aggSizetPivotToColumnsDelimited_1 < pivotNumtPivotToColumnsDelimited_1) {
									...
									aggStrtPivotToColumnsDelimited_1.add(String.valueOf(row1.releaseYear));
									...
									if (("").equals(
											aggStrtPivotToColumnsDelimited_1.get(pivotIndextPivotToColumnsDelimited_1)))

										aggStrtPivotToColumnsDelimited_1.set(pivotIndextPivotToColumnsDelimited_1,
												String.valueOf(row1.releaseYear));
...
///////////////////////		
							...
							if (row2.movieID != null) { //
								row_tLogRow_1[0] = String.valueOf(row2.movieID);

							} //

							if (row2.title != null) { //
								row_tLogRow_1[1] = String.valueOf(row2.title);

							} //

							if (row2.releaseYear != null) { //
								row_tLogRow_1[2] = String.valueOf(row2.releaseYear);

							} //

							if (row2.url != null) { //
								row_tLogRow_1[3] = String.valueOf(row2.url);

							} //

							if (row2.directorID != null) { //
								row_tLogRow_1[4] = String.valueOf(row2.directorID);
...
///////////////////////    			
					...
					if (!((Object) ("C:/Users/talend/Desktop/movies.csv") instanceof java.io.InputStream)) {
				...
				outtPivotToColumnsDelimited_1.write("movieID");
...
///////////////////////    			
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_gerarchie) {
				...
				try {
					...
					this.columnLabel = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.columnLabel, dos);
	...
	public static class OnRowsEndStructtTranspose_1
			implements routines.system.IPersistableRow<OnRowsEndStructtTranspose_1> {
		final static byte[] commonByteArrayLock_DEMO_gerarchie = new byte[0];
		static byte[] commonByteArray_DEMO_gerarchie = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OnRowsEndStructtTranspose_1 other) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				/**
				 * [tTranspose_1_TransposeOut begin ] start
				 */

				ok_Hash.put("tTranspose_1_TransposeOut", false);
				start_Hash.put("tTranspose_1_TransposeOut", System.currentTimeMillis());

				currentVirtualComponent = "tTranspose_1";

				currentComponent = "tTranspose_1_TransposeOut";

				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "row3");
				}

				int tos_count_tTranspose_1_TransposeOut = 0;

				java.util.ArrayList<java.util.ArrayList<String>> listOfList_tTranspose_1 = new java.util.ArrayList<java.util.ArrayList<String>>();
				globalMap.put("array_tTranspose_1", listOfList_tTranspose_1);

				Integer nb_input_tTranspose_1 = 0;

				/**
				 * [tTranspose_1_TransposeOut begin ] stop
				 */
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/talend/Desktop/movies.csv";
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row3.columnLabel = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row3"
						if (row3 != null) {
							...
							/**
							 * [tTranspose_1_TransposeOut main ] start
							 */
							...
							java.util.ArrayList<String> rowListtTranspose_1_TransposeOut = new java.util.ArrayList<String>();
							rowListtTranspose_1_TransposeOut.add(row3.columnLabel);
							listOfList_tTranspose_1.add(rowListtTranspose_1_TransposeOut);
							nb_input_tTranspose_1++;

							tos_count_tTranspose_1_TransposeOut++;

							/**
							 * [tTranspose_1_TransposeOut main ] stop
							 */

							/**
							 * [tTranspose_1_TransposeOut process_data_begin ] start
							 */
							...
							/**
							 * [tTranspose_1_TransposeOut process_data_begin ] stop
							 */

							/**
							 * [tTranspose_1_TransposeOut process_data_end ] start
							 */
							...
							/**
							 * [tTranspose_1_TransposeOut process_data_end ] stop
							 */
				...
				/**
				 * [tTranspose_1_TransposeOut end ] start
				 */
				...
				ok_Hash.put("tTranspose_1_TransposeOut", true);
				end_Hash.put("tTranspose_1_TransposeOut", System.currentTimeMillis());

				/**
				 * [tTranspose_1_TransposeOut end ] stop
				 */
				...
				util_tLogRow_2.addRow(new String[] { "columnLabel", });
...
///////////////////////    			
				...
				/**
				 * [tTranspose_1_TransposeIn begin ] start
				 */

				ok_Hash.put("tTranspose_1_TransposeIn", false);
				start_Hash.put("tTranspose_1_TransposeIn", System.currentTimeMillis());

				currentVirtualComponent = "tTranspose_1";

				currentComponent = "tTranspose_1_TransposeIn";

				int tos_count_tTranspose_1_TransposeIn = 0;

// column list
				java.util.ArrayList<String> listColumn_tTranspose_1 = new java.util.ArrayList<String>();
				listColumn_tTranspose_1.add("columnLabel");

				Integer nb_output_tTranspose_1 = 0;

				for (int i = 0; i < 1; i++) {

					nb_output_tTranspose_1++;

					java.util.ArrayList<String> rowListtTranspose_1_TransposeIn = new java.util.ArrayList<String>();
					row4.columnLabel = listColumn_tTranspose_1.get(i);

					/**
					 * [tTranspose_1_TransposeIn begin ] stop
					 */

					/**
					 * [tTranspose_1_TransposeIn main ] start
					 */
					...
					tos_count_tTranspose_1_TransposeIn++;

					/**
					 * [tTranspose_1_TransposeIn main ] stop
					 */

					/**
					 * [tTranspose_1_TransposeIn process_data_begin ] start
					 */
					...
					/**
					 * [tTranspose_1_TransposeIn process_data_begin ] stop
					 */
...
///////////////////////		
					...
					if (row4.columnLabel != null) { //
						row_tLogRow_2[0] = String.valueOf(row4.columnLabel);
...
///////////////////////    			
					...
					/**
					 * [tTranspose_1_TransposeIn process_data_end ] start
					 */
					...
					/**
					 * [tTranspose_1_TransposeIn process_data_end ] stop
					 */

					/**
					 * [tTranspose_1_TransposeIn end ] start
					 */
				...
				globalMap.put("tTranspose_1_NB_LINE_INPUT", nb_input_tTranspose_1);
				globalMap.put("tTranspose_1_NB_LINE_OUTPUT", nb_output_tTranspose_1);

				ok_Hash.put("tTranspose_1_TransposeIn", true);
				end_Hash.put("tTranspose_1_TransposeIn", System.currentTimeMillis());

				/**
				 * [tTranspose_1_TransposeIn end ] stop
				 */
...
///////////////////////    			
			...
			// free memory for "tTranspose_1_TransposeIn"
			globalMap.remove("tTranspose_1");
			...
			try {
				...
				/**
				 * [tTranspose_1_TransposeOut finally ] start
				 */
				...
				/**
				 * [tTranspose_1_TransposeOut finally ] stop
				 */

				/**
				 * [tTranspose_1_TransposeIn finally ] start
				 */
				...
				/**
				 * [tTranspose_1_TransposeIn finally ] stop
				 */
	...
	public static void main(String[] args) {
		final gerarchie gerarchieClass = new gerarchie();

		int exitCode = gerarchieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = gerarchie.class.getClassLoader()
					.getResourceAsStream("demo/gerarchie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = gerarchie.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : gerarchie");
		}
...
/************************************************************************************************
 * 90660 characters generated by Talend Open Studio for Data Integration on the
 * May 19, 2021 at 11:58:09 AM CEST
 ************************************************************************************************/